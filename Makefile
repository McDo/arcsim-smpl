...
CXXFLAGS := -Idependencies/include -I/usr/local/include
ifdef NO_OPENGL
...
LDFLAGS := -Ldependencies/lib -L/usr/local/lib -lpng -lz -ltaucs -llapack -lblas -lboost_filesystem -lboost_system -lboost_thread -ljsoncpp -lgomp -lalglib
